...
class SettingsController extends Controller {
    ...
    { 
        ...
        return view('packages::setting.edit', compact('facebook_url','twitter_url','linkedin_url','setting','website_title','website_email','website_url','contact_number','company_address','banner', 'page_title', 'page_action'));
